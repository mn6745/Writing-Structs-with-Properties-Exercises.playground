...
let wilson = Author(firstName: "Wilson", lastName: "Rawls", living: false)

var fern = Book(title: "Where the Red Fern Grows", author: wilson, pages: 245, numberOfStars: 4, description: "About a young boy and his hunting dogs", genre: "Childrens Book")

let john = Author(firstName: "John Ronald Reuel", lastName: "Tolien", living: false)

var hobbit = Book(title: "The Hobbit", author: john, pages: 300, numberOfStars: 4.5, description: "Treasure seeking quest of hobbit Bilbo Baggins", genre: "Fantasy")

let mary = Author(firstName: "Mary", lastName: "Shelley", living: false)

var frankenstein = Book(title: "Frankenstein", author: mary, pages: 200, numberOfStars: 4.7, description: "Young science student creates a sentient creature", genre: "Gothic Novel")
